...
| 编号 | 文档名称 | 版本 | 说明 |
|------|----------|------|------|
| 01 | [系统架构设计](docs/01-技术方案/01-系统架构设计.md) | V1.7 | 模块划分、数据模型、时序图 |
| 02 | [API接口文档](docs/01-技术方案/02-API接口文档.md) | V1.7 | WebSocket/HTTP/UDP接口定义 |
| 04 | [快速开始指南](docs/01-技术方案/04-快速开始指南.md) | V1.7 | 首次运行与开发流程 |
| 05 | [项目代码规范](docs/01-技术方案/05-项目代码规范.md) | V1.7 | 编码规范和Git流程 |
| 06 | [部署指南](docs/01-技术方案/06-部署指南.md) | V1.7 | 部署流程、启动测试、故障排查 |
| 07 | [数据采集规范](docs/01-技术方案/07-数据采集规范.md) | V1.7 | 数据结构、命名规则、备份策略 |
| 08 | [环境诊断与故障排查指南](docs/01-技术方案/08-环境诊断与故障排查指南.md) | V1.7 | 一键诊断与故障排查 |
| 10 | [环境配置指南](docs/01-技术方案/10-环境配置指南.md) | V1.7 | 主机配置、软件环境、网络拓扑 |
| 11 | [测试用例与验收标准](docs/01-技术方案/11-测试用例与验收标准.md) | V1.7 | 功能测试、性能测试、验收标准 |
...
| 编号 | 文档名称 | 版本 | 说明 |
|------|----------|------|------|
| 01 | [物料清单](docs/02-项目管理/01-物料清单.md) | V1.7 | 硬件采购与加工跟踪 |
| 02 | [团队分工](docs/02-项目管理/02-团队分工.md) | V1.7 | 成员职责与协作流程 |
| 03 | [项目实施规划书](docs/02-项目管理/03-项目实施规划书.md) | V1.7 | 云端环境、部署流程、时间计划 |
