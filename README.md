...
| `hybrid` | 运动控制真实，感知模拟 | 硬件联调 |

> **说明**：系统默认使用模拟模式，可在无模型环境下完整运行 12 分钟演示流程。详见 [代码审查与模拟架构文档](docs/01-技术方案/07-代码审查与模拟架构.md)。
...
| **开发状态** | V1.1 已支持无模型环境运行 |
| **核心文档** | [系统架构设计](docs/01-技术方案/01-系统架构设计.md) |
| **实施规划** | [项目实施规划书](docs/02-项目管理/03-项目实施规划书.md) |
...
```mermaid
graph LR
    Platform["📊 监测平台<br/>192.168.1.200"]
    NX["🖥️ Jetson NX<br/>192.168.1.103"]
    Motion["🦴 RK3588运动主机<br/>192.168.1.103"]
    PTZ["📷 云台相机<br/>192.168.1.108"]
...
| 06 | [部署运维指南](docs/01-技术方案/06-部署运维指南.md) | 远程访问、部署流程、故障排查 |
| 07 | [代码审查与模拟架构](docs/01-技术方案/07-代码审查与模拟架构.md) | 审查结果、模拟运行方案 |
...
| 编号 | 文档名称 | 说明 |
|------|----------|------|
| 01 | [物料清单](docs/02-项目管理/01-物料清单.md) | 硬件采购与加工跟踪 |
| 02 | [团队分工](docs/02-项目管理/02-团队分工.md) | 成员职责与协作流程 |
| 03 | [项目实施规划书](docs/02-项目管理/03-项目实施规划书.md) | 云端环境、部署流程、时间计划 |
...
*项目版本: V1.1 | 编制日期: 2026-08-20 | 编制人: 陈伟*
